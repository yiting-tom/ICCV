...
log_dir=../../logs
save_dir=../../wsdm_checkpoints
mkdir -p $log_dir $save_dir

bpe_dir=../../utils/BPE
user_dir=../../ofa_module

tag="9train_1dev+mplug-comma"
data_dir=../../dataset
data=${data_dir}/mplug/"train_que+train_que_aug-9train-comma.tsv",${data_dir}/mplug/"train_que+train_que_aug-1dev-comma.tsv"
